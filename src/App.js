          ...
          <>
            ...
            <div className={"flex-grow-1 h-100 bg-light"}>
                ...
                <main className="mt-2">
                  <article className="col-lg-12">
                    <header className="flex-grow-1">
                      ...
                      <div className="alert alert-success"><strong><a href="//twitter.com/joshmlxn">Follow me on
              ...
              <footer className="footer p-3 bg-white d-flex flex-row border-top">
					<span className="text-muted align-self-start">&copy; <a href="https://mlxn.ltd"
                                                                            className={"text-decoration-none"}>MLXN Ltd</a> 2020-2021. All rights
						reserved.</span>
                <span className={"mx-2"}><a href="//cryptologos.net"
                                            className={"text-decoration-none"}>Crypto Logos</a></span>
                <span className={"mx-2"}><a href="//twitter.com/joshmlxn" className={"text-decoration-none"}>Twitter</a></span>
